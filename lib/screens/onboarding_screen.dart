    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text(
            'Your local, secure, and smart mobile companion. Ultron-3 can navigate apps, perform operations, and speak with you.',
              ...
              children: [
                ...
                if (FeatureFlags.floatingOverlayEnabled) ...[
                  ...
                  _buildPermissionCard(
                    ...
                    'Allows Ultron-3 to show a floating overlay bubble when backgrounded or executing a task so you can monitor progress and execute actions.',
                ...
                _buildPermissionCard(
                  'Notifications',
                  'Allows Ultron-3 to show ongoing tasks, alerts, and execution updates in your notification tray.',
