...
class _OverlayAppState extends State<OverlayApp> {
  ...
  void initState() {
    ...
    _messages.add(
      ChatMessage(
        role: 'assistant',
        content:
            'Hi! I am your Ultron-3. Ask me to perform any task on your screen.',
      ),
    );
  }
  ...
  Future<void> _initializeServices() async {
    ...
    final intent = const AndroidIntent(
      action: 'com.ultron.llm.REGISTER_BACKGROUND_CHANNELS',
  ...
  Future<void> _openMainApp() async {
    ...
    const intent = AndroidIntent(
      ...
      package: 'com.ultron.llm',
      componentName: 'com.ultron.llm.MainActivity',
      flags: <int>[
