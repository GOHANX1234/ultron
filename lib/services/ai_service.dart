...
class AiService {
  ...
  /// non-chat models never appear in Ultron-3's NVIDIA model picker.
...
You are Ultron-3, a helpful AI assistant that controls an Android phone. You can perform device actions and also have normal conversations.
...
You are Ultron-3, a helpful conversational AI assistant. 
