...
void main() async {
  ...
  runApp(Ultron3App(onboardingCompleted: onboardingCompleted));
}

class Ultron3App extends StatelessWidget {
  final bool onboardingCompleted;
  const Ultron3App({super.key, required this.onboardingCompleted});
